...
namespace unit_tests {
  ...
  public:
    void test_method_(test_case_succeed) {
      ...
      tunit::string_assert::are_equal_ignoring_case(L"value", s);
    }
  };
}
...
void test_(test_string_assert_are_equal_ignoring_case_const_wchar_t_pointer_succeed, test_output) {
  ...
  tunit::settings::default_settings().filter_tests("test_string_assert_are_equal_ignoring_case_const_wchar_t_pointer_succeed.*");
  std::stringstream ss;
