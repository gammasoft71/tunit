/// @file
/// @brief Contains tunit::collection_valid class.
#pragma once
#include "valid.h"
...
namespace tunit {
  /// @brief The collection_valid class contains a collection of static methods that implement the most collection assertions used in tUnit.
  /// @par Examples
  ...
  public:
    ...
    /// tunit::collection_valid::all_items_are_instances_of<std::ios_base*>(a); // test ok.
    /// tunit::collection_valid::all_items_are_instances_of<std::basic_ostream<char>*>(a); // test fails.
    /// @endcode
    ...
    /// @code
    /// std::vector<std::ios_base*> a = {&std::cout, &std::cerr, &std::cin};
    /// tunit::collection_valid::all_items_are_instances_of<std::ios_base*>(a, "User message..."); // test ok.
    /// tunit::collection_valid::all_items_are_instances_of<std::basic_ostream<char>*>(a, "User message..."); // test fails.
    /// @endcode
    template<typename TExpected, typename TCollection>
    ...
    /// @code
    /// std::vector<std::ios_base*> a = {&std::cout, &std::cerr, &std::cin};
    /// tunit::collection_valid::all_items_are_instances_of<std::ios_base*>(a, line_info_); // test ok.
    /// tunit::collection_valid::all_items_are_instances_of<std::basic_ostream<char>*>(a, line_info_); // test fails.
    /// @endcode
    template<typename TExpected, typename TCollection>
    ...
    /// @code
    /// std::vector<std::ios_base*> a = {&std::cout, &std::cerr, &std::cin};
    /// tunit::collection_valid::all_items_are_instances_of<std::ios_base*>(a, "User message...", line_info_); // test ok.
    /// tunit::collection_valid::all_items_are_instances_of<std::basic_ostream<char>*>(a, "User message...", line_info_); // test fails.
    /// @endcode
    template<typename TExpected, typename TCollection>
    ...
    /// tunit::collection_valid::all_items_are_not_null(a1); // test ok.
    /// std::vector<int*> a2 = {&i1, &i2, nullptr};
    /// tunit::collection_valid::all_items_are_not_null(a2); // test fails.
    /// @endcode
    ...
    /// int i1 = 0, i2 = 3;
    /// std::vector<int*> a1 = {&i1, &i2};
    /// tunit::collection_valid::all_items_are_not_null(a1, "User message..."); // test ok.
    /// std::vector<int*> a2 = {&i1, &i2, nullptr};
    /// tunit::collection_valid::all_items_are_not_null(a2, "User message..."); // test fails.
    /// @endcode
    template<typename TCollection>
    ...
    /// int i1 = 0, i2 = 3;
    /// std::vector<int*> a1 = {&i1, &i2};
    /// tunit::collection_valid::all_items_are_not_null(a1, line_info_); // test ok.
    /// std::vector<int*> a2 = {&i1, &i2, nullptr};
    /// tunit::collection_valid::all_items_are_not_null(a2, line_info_); // test fails.
    /// @endcode
    template<typename TCollection>
    ...
    /// int i1 = 0, i2 = 3;
    /// std::vector<int*> a1 = {&i1, &i2};
    /// tunit::collection_valid::all_items_are_not_null(a1, "User message...", line_info_); // test ok.
    /// std::vector<int*> a2 = {&i1, &i2, nullptr};
    /// tunit::collection_valid::all_items_are_not_null(a2, "User message...", line_info_); // test fails.
    /// @endcode
    template<typename TCollection>
    ...
    /// tunit::collection_valid::all_items_are_unique(a1); // test ok.
    /// std::vector<int> a2 = {1, 2, 3, 4, 1};
    /// tunit::collection_valid::all_items_are_unique(a2); // test fails.
    /// @endcode
    template<typename TCollection>
    ...
    /// @code
    /// std::vector<int> a1 = {1, 2, 3, 4};
    /// tunit::collection_valid::all_items_are_unique(a1, "User message..."); // test ok.
    /// std::vector<int> a2 = {1, 2, 3, 4, 1};
    /// tunit::collection_valid::all_items_are_unique(a2, "User message..."); // test fails.
    /// @endcode
    template<typename TCollection>
    ...
    /// @code
    /// std::vector<int> a1 = {1, 2, 3, 4};
    /// tunit::collection_valid::all_iall_items_are_uniquetems_are_not_null(a1, line_info_); // test ok.
    /// std::vector<int> a2 = {1, 2, 3, 4, 1};
    /// tunit::collection_valid::all_items_are_unique(a2, line_info_); // test fails.
    /// @endcode
    template<typename TCollection>
    ...
    /// @code
    /// std::vector<int> a1 = {1, 2, 3, 4};
    /// tunit::collection_valid::all_items_are_unique(a1, "User message...", line_info_); // test ok.
    /// std::vector<int> a2 = {1, 2, 3, 4, 1};
    /// tunit::collection_valid::all_items_are_unique(a2, "User message...", line_info_); // test fails.
    /// @endcode
    template<typename TCollection>
    ...
    /// tunit::collection_valid::are_equal({1, 2, 3, 4}, a); // test ok.
    /// tunit::collection_valid::are_equal({4, 3, 2, 1}, a); // test fails.
    /// @endcode
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_equal({1, 2, 3, 4}, a, "User message..."); // test ok.
    /// tunit::collection_valid::are_equal({4, 3, 2, 1}, a, "User message..."); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_equal({1, 2, 3, 4}, a, line_info_); // test ok.
    /// tunit::collection_valid::are_equal({4, 3, 2, 1}, a, line_info_); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_equal({1, 2, 3, 4}, a, "User message...", line_info_); // test ok.
    /// tunit::collection_valid::are_equal({4, 3, 2, 1}, a, "User message...", line_info_); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_equivalent({4, 3, 2, 1}, a); // test ok.
    /// tunit::collection_valid::are_equivalent({1, 2, 3, 5}, a); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_equivalent({4, 3, 2, 1}, a, "User message..."); // test ok.
    /// tunit::collection_valid::are_equivalent({1, 2, 3, 5}, a, "User message..."); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_equivalent({4, 3, 2, 1}, a, line_info_); // test ok.
    /// tunit::collection_valid::are_equivalent({1, 2, 3, 5}, a, line_info_); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_equivalent({4, 3, 2, 1}, a, "User message...", line_info_); // test ok.
    /// tunit::collection_valid::are_equivalent({1, 2, 3, 5}, a, "User message...", line_info_); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_not_equal({4, 3, 2, 1}, a); // test ok.
    /// tunit::collection_valid::are_not_equal({1, 2, 3, 4}, a); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_not_equal({4, 3, 2, 1}, a, "User message..."); // test ok.
    /// tunit::collection_valid::are_not_equal({1, 2, 3, 4}, a, "User message..."); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_not_equal({4, 3, 2, 1}, a, line_info_); // test ok.
    /// tunit::collection_valid::are_not_equal({1, 2, 3, 4}, a, line_info_); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_not_equal({4, 3, 2, 1}, a, "User message...", line_info_); // test ok.
    /// tunit::collection_valid::are_not_equal({1, 2, 3, 4}, a, "User message...", line_info_); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_not_equivalent({1, 2, 3, 5}, a); // test ok.
    /// tunit::collection_valid::are_not_equivalent({4, 3, 2, 1}, a); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_not_equivalent({1, 2, 3, 5}, a, "User message..."); // test ok.
    /// tunit::collection_valid::are_not_equivalent({4, 3, 2, 1}, a, "User message..."); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_not_equivalent({1, 2, 3, 5}, a, line_info_); // test ok.
    /// tunit::collection_valid::are_not_equivalent({4, 3, 2, 1}, a, line_info_); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::are_not_equivalent({1, 2, 3, 5}, a, "User message...", line_info_); // test ok.
    /// tunit::collection_valid::are_not_equivalent({4, 3, 2, 1}, a, "User message...", line_info_); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::contains({1, 2, a); // test ok.
    /// tunit::collection_valid::contains({1, 2, 6}, a); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::contains({1, 2}, a, "User message..."); // test ok.
    /// tunit::collection_valid::contains({1, 2, 6}, a, "User message..."); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::contains({1, 2}, a, line_info_); // test ok.
    /// tunit::collection_valid::contains({1, 2, 6}, a, line_info_); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::contains({1, 2}, a, "User message...", line_info_); // test ok.
    /// tunit::collection_valid::contains({1, 2, 6}, a, "User message...", line_info_); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::does_not_contain({1, 2, a); // test ok.
    /// tunit::collection_valid::does_not_contain({1, 2, 6}, a); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::does_not_contain({1, 2}, a, "User message..."); // test ok.
    /// tunit::collection_valid::does_not_contain({1, 2, 6}, a, "User message..."); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::does_not_contain({1, 2}, a, line_info_); // test ok.
    /// tunit::collection_valid::does_not_contain({1, 2, 6}, a, line_info_); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// @code
    /// std::vector<int> a = {1, 2, 3, 4};
    /// tunit::collection_valid::does_not_contain({1, 2}, a, "User message...", line_info_); // test ok.
    /// tunit::collection_valid::does_not_contain({1, 2, 6}, a, "User message...", line_info_); // test fails.
    /// @endcode
    template<typename TExpected, typename TAcutal>
    ...
    /// tunit::assert::is_empty(v2); // test fails
    /// @endcode
    ...
    /// tunit::assert::is_empty(v2, line_info_); // test fails
    /// @endcode
    template<typename TValue>
    ...
    /// tunit::assert::is_empty(v2, "User message..."); // test fails
    /// @endcode
    template<typename TValue>
    ...
    /// tunit::assert::is_empty(v2, "User message...", line_info_); // test fails
    /// @endcode
    template<typename TValue>
    ...
    /// tunit::assert::is_not_empty(v2); // test fails
    /// @endcode
    template<typename TValue>
    ...
    /// tunit::assert::is_not_empty(v2, line_info_); // test fails
    /// @endcode
    template<typename TValue>
    ...
    /// tunit::assert::is_not_empty(v2, "User message..."); // test fails
    /// @endcode
    template<typename TValue>
    ...
    /// tunit::assert::is_not_empty(v2, "User message...", line_info_); // test fails
    /// @endcode
    template<typename TValue>
    ...
    /// tunit::assert::is_ordered(v2); // test fails
    /// @endcode
    template<typename TValue>
    ...
    /// tunit::assert::is_ordered(v2, line_info_); // test fails
    /// @endcode
    template<typename TValue>
    ...
    /// tunit::assert::is_ordered(v2, "User message..."); // test fails
    /// @endcode
    template<typename TValue>
    ...
    /// tunit::assert::is_ordered(v2, "User message...", line_info_); // test fails
    /// @endcode
    template<typename TValue>
