/// @file
/// @brief Contains tunit::class_cleanup_attribute class.
#pragma once
#include "test.h"
...
namespace tunit {
  ...
  public:
    ...
    /// @param test_class tunit::class_test containing clean_up method.
    /// @param method Cleanup class method.
    template<typename TestClass>
    class_cleanup_attribute(const std::string& name, TestClass& test_class, void (*method)()) noexcept :  class_cleanup_attribute(name, test_class, method, tunit::line_info()) {}
    ...
    template<typename TestClass>
    class_cleanup_attribute(const std::string& name, TestClass& test_class, void (*method)(), const tunit::line_info& line_info) noexcept {test_class.add_class_cleanup({name, method, line_info});}
  };
}
...
#define class_cleanup_(method_name) \
  ...
  class __class_cleanup_attribute : public tunit::class_cleanup_attribute { \
  public:\
