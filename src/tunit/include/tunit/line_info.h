/// @file
/// @brief Contains tunit::line_info class.
#pragma once
#include <ostream>
#include <string>
...
namespace tunit {
  ...
  public:
    ...
    static tunit::line_info empty() {return {};}
    ...
    /// @cond
    friend std::ostream& operator<<(std::ostream& os, const tunit::line_info line_info) noexcept {
...
/// @brief Get tunit::line_info informations
/// @return tunit::line_info line informations.
/// @par Examples
/// The following example shows how to use the #line_info_.
/// @include line_info.cpp
/// @ingroup tunit
#define line_info_ \
  tunit::line_info {__func__, __FILE__, __LINE__}
