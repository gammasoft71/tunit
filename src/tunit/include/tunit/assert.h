/// @file
/// @brief Contains tunit::assert class.
#pragma once
...
namespace tunit {
  ...
  public:
    ...
    /// int& b = a;
    /// int c=  24;
    /// tunit::assert::are_not_same(c, a, line_info_); // test ok.
    ...
    /// int& b = a;
    /// int c=  24;
    /// tunit::assert::are_same(b, a, line_info_); // test ok.
    ...
    /// @par Examples
    /// @code
    /// tunit::assert::is_greater(24, 12, line_info_); // test ok.
    ...
    /// @par Examples
    /// @code
    /// tunit::assert::is_greater_or_equal(24, 12); // test ok.
    /// tunit::assert::is_greater_or_equal(24, 24); // test ok.
    ...
    /// @par Examples
    /// @code
    /// tunit::assert::is_greater_or_equal(24, 12, line_info_); // test ok.
    /// tunit::assert::is_greater_or_equal(24, 24, line_info_); // test ok.
    ...
    /// @par Examples
    /// @code
    /// tunit::assert::is_less_or_equal(24, 48, line_info_); // test ok.
    /// tunit::assert::is_less_or_equal(24, 24, line_info_); // test ok.
    ...
    /// double v1 = std::numeric_limits<double>::quiet_NaN();
    /// double v2 = 3.14159265358979323846;
    /// tunit::assert::is_NaN(v1, line_info_); // test ok.
    ...
    /// int i1 = -1;
    /// int i2 = 1;
    /// tunit::assert::is_negative(i1); // test ok.
    ...
    /// int i1 = -1;
    /// int i2 = 1;
    /// tunit::assert::is_negative(i1, line_info_); // test ok.
    ...
    /// tunit::assert::is_not_null(s1); // test ok.
    ...
    /// std::string* s1 = &str;
    /// std::string* s2 = nullptr;
    /// tunit::assert::is_not_null(s1, line_info_); // test ok.
    ...
    /// tunit::assert::is_not_null(s1); // test ok.
    /// tunit::assert::is_not_null(s2); // test ok.
    /// @endcode
    template<typename TPointer>
    ...
    /// std::weak_ptr<std::string> s2;
    /// tunit::assert::is_not_null(s1, line_info_); // test ok.
    /// tunit::assert::is_not_null(s2, line_info_); // test ok.
    /// @endcode
    template<typename TPointer>
    ...
    /// @endcode
    template<typename TPointer>
    static void is_not_null(const std::weak_ptr<TPointer>& pointer, const std::string& message, const tunit::line_info& line_info) {succeed(message, line_info);}
    ...
    /// @endcode
    static void is_not_null(std::nullptr_t pointer, const std::string& message, const tunit::line_info& line_info) {base_assert::fail("not null", "null", message, line_info);}
    ...
    /// int i1 = 42;
    /// int i2 = 0;
    /// tunit::assert::is_not_zero(i1); // test ok.
    ...
    /// int i1 = 42;
    /// int i2 = 0;
    /// tunit::assert::is_not_zero(i1, line_info_); // test ok.
    ...
    /// std::string* s1 = nullptr;
    /// std::string* s2 = &str;
    /// tunit::assert::is_null(s1, line_info_); // test ok.
    ...
    /// @endcode
    template<typename TPointer>
    static void is_null(const std::weak_ptr<TPointer>& pointer, const std::string& message, const tunit::line_info& line_info) {base_assert::fail("null", "not null", message, line_info);}
    ...
    /// @endcode
    static void is_null(std::nullptr_t pointer, const std::string& message, const tunit::line_info& line_info) {succeed(message, line_info);}
    ...
    /// int i1 = 1;
    /// int i2 = -1;
    /// tunit::assert::is_positive(i1); // test ok.
    ...
    /// int i1 = 1;
    /// int i2 = -1;
    /// tunit::assert::is_positive(i1, line_info_); // test ok.
    ...
    /// int i1 = 0;
    /// int i2 = 42;
    /// tunit::assert::is_zero(i1, line_info_); // test ok.
